...
from ShikimoriMusic import ASS_USERNAME, BOT_NAME, BOT_USERNAME
from ShikimoriMusic.vars import SUPPORT_CHAT, UPDATE
from ShikimoriMusic.plugins.admins import member_permissions
...
mostly, there wiil be the main error about to music assistant. If you are facing any type of error in your group then that time first make sure @{ASS_USERNAME} is available in your group. If not then add it manually and before that make sure also it is not banned in ur chat.\n\n**Assistant :- @{ASS_USERNAME}**\n\n**Thanks !**""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                    InlineKeyboardButton("Assistant 🙋🏻‍♂️", url=f"https://t.me/{ASS_USERNAME}")
                ],
